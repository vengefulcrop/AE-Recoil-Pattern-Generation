...
;-------Variables---------
	...
	outputfile  := "r301_SFnew_fin.txt"												;output file name, doesn't override, but can create a new file if it didn't exist
	...
	cmody := 0.53 																	;0.68	multiplier. multiply all x or y coordinates by a number to control the strenght 
	cmodx := 0.67 																	;0.85   values around 0.5-0.8 seem to work best
	
	~$*LButton::
	   if (GetKeyState("LButton", "P") && GetKeyState("RButton", "P")) { 												;if rbutton held
       Loop
        {   
